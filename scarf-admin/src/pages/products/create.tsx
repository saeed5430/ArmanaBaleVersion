...
import { Form, Input, Select, Switch, Card, Space, Button, Modal, ColorPicker, message, Tag } from "antd";
    ...
    <Create saveButtonProps={saveButtonProps}>
      ...
      >
        ...
        <Card
          ...
          extra={
            <Button type="link" icon={<PlusOutlined />} onClick={() => setColorModalOpen(true)}>
              رنگ جدید
            </Button>
          }
        >
        ...
        <Card
          ...
          style={{ marginBottom: 16 }}
          extra={
            <Button type="link" icon={<PlusOutlined />} onClick={() => setSizeModalOpen(true)}>
              سایز جدید
            </Button>
          }
        >
